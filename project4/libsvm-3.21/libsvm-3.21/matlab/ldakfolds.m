function [splitfile,classlabel,difflabel,accur,taccprint]= ldakfolds( kvalue,sample,lvecs,method,knnval,svmthd )
...
for j=1:kfold
    ...
    if lvecs==0
        [ldtrdata,ldavecs]=ldadr(traindata(2:end,1:end),trainlabel');
        traindata=vertcat(trainlabel,ldtrdata);
        testdata=ldavecs'*testdata;
    end
